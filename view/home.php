...
<?php if (isset($_GET['search'])): ?>
    ...
    <?php if (empty($product)): ?>
        <p class="text-danger mb-3" style="margin-left: 60px; font-size: 20px; font-weight: bold;">Không tìm thấy sản phẩm nào.</p>
    <?php else: ?>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card border-0 mb-4 product-item">
                        ...
                        <div class="card-body border-left border-right p-0 text-center pb-3 pt-4">
                            <h6 class="text-truncate mb-3"><?= htmlspecialchars($p['title']) ?></h6>
                        ...
                        <div class="d-flex card-footer bg-light border justify-content-between">
                            <a href="index.php?act=ProductDetail&id=<?= $p['id'] ?>" class="btn btn-sm p-0 text-dark">
                                <i class="text-primary fa-eye fas mr-1"></i>View Detail
                            </a>
                            <a href="index.php?act=addToCart&id=<?= $p['id'] ?>" class="btn btn-sm p-0 text-dark">
                                <i class="text-primary fa-shopping-cart fas mr-1"></i>Add To Cart
                            </a>
                        </div>
                    </div>
                </div>
...
<?php else: ?>
                ...
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="d-flex flex-column border cat-item mb-4" style="padding: 30px;">
                        <a href="index.php?act=cate&id=<?= $cat['id'] ?>" class="position-relative cat-img mb-3 overflow-hidden">
                            <img class="img-fluid" src="view/img/cat-<?= $cat['id'] ?>.jpg" alt="">
                        </a>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="px-5 section-title"><span class="px-2">Trendy Products</span></h2>
        </div>
