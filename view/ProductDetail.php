        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex mb-3">
                    ...
                    <?php foreach ($size as $index => $s): ?>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="size<?= $index ?>" name="size" value="<?= $s['name'] ?>"
                    ...
                    <?php foreach ($color as $index => $c): ?>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="color<?= $index ?>" name="color"
                                value="<?= htmlspecialchars($c['name']) ?>" class="custom-control-input" required>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <a href="index.php?act=cart&id=<?= $product['id'] ?>"><button class="btn btn-primary px-3"><i
                                class="fa fa-shopping-cart mr-1"></i>Add To Cart </button></a>
                </div>
